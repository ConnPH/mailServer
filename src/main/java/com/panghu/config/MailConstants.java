...
public class MailConstants {
    ...
    public static final Integer DEFAULT_MSG_TRY_COUNT = 0;//默认重试次数
    public static final String MAIL_QUEUE_NAME = "qq.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "qq.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "qq.mail.routing.key";
